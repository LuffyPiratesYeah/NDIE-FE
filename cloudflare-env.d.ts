/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: da17e8c340439807292f59a60db198d5)
// Runtime types generated with workerd@1.20251109.0 2025-09-15 enable_nodejs_process_v2,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.open-next/worker");
	}
	interface Env {
		"0": {"name":"NEXT_PUBLIC_API_BASE","value":"https://ndie-be-985895714915.europe-west1.run.app/"};
		"1": {"name":"EMAIL_HOST","value":"smtp.gmail.com"};
		"2": {"name":"EMAIL_PORT","value":"587"};
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "0" | "1" | "2">> {}
}
